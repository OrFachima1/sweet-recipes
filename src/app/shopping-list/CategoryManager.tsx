            ...
            <div className="bg-white rounded-3xl p-6 w-full max-w-md shadow-2xl" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="space-y-3">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border-2 border-gray-300 focus:border-blue-500 focus:outline-none text-2xl"
                  style={{ fontFamily: 'MyHandwriting, Arial' }}
                  autoFocus
                />
                <div className="grid grid-cols-2 gap-3">
                  <input
                    ...
                    className="px-4 py-3 rounded-xl border-2 border-gray-300 focus:border-blue-500 focus:outline-none text-2xl"
                    style={{ fontFamily: 'MyHandwriting, Arial' }}
                  />
                  <input
                    type="text"
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 px-6 py-3 rounded-xl bg-gradient-to-l from-blue-500 to-cyan-500 text-white font-bold hover:shadow-lg text-2xl"
                    style={{ fontFamily: 'MyHandwriting, Arial' }}
                  >
                    הוסף
                  </button>
                  <button
                    ...
                    className="px-6 py-3 rounded-xl bg-gray-200 hover:bg-gray-300 text-2xl"
                    style={{ fontFamily: 'MyHandwriting, Arial' }}
                  >
                    ביטול
                  </button>
