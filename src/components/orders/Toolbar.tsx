    ...
    <div className="flex items-center gap-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          className="px-3 py-2 rounded-lg bg-white border border-gray-200 text-sm hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-pink-300 transition-all text-gray-900"
        />
      </div>
    </div>
  );
