              ...
              return (
                <div
                  ...
                  className={`
                    ...
                    ${cell.inMonth ? 'bg-gray-50 border-gray-200 hover:bg-gray-100' : 'bg-gray-50/30 border-transparent'}
            ...
            return (
              <div
                ...
                className={`
                  ...
                  ${cell.inMonth ? 'bg-white border-gray-200 hover:bg-orange-50/30' : 'bg-gray-50/30 border-transparent'}
