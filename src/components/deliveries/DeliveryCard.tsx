      ...
      <div className="bg-white px-4 py-3 space-y-3">
        ...
        {order.address && (
          <div className="flex items-start gap-2 text-gray-700">
            ...
            >
              <svg className="w-5 h-5 mt-0.5 flex-shrink-0 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
              <span className="text-sm underline">{order.address}</span>
            </a>
          </div>
        )}
          ...
          {order.phone1 && (
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                ...
                <a href={`tel:${order.phone1}`} className="text-blue-600 hover:text-blue-800">
                  {order.phone1}
                </a>
              </div>
            </div>
          ...
          {order.phone2 && (
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                ...
                <a href={`tel:${order.phone2}`} className="text-blue-600 hover:text-blue-800">
                  {order.phone2}
                </a>
              </div>
            </div>
